...
re = np.array(two_data["real"][:200])
si_2 = np.array(two_data["sigmoid"][:200])
si_5 = np.array(five_data["sigmoid"][:200])
rmse_2 = np.sqrt(np.mean((re - si_2)**2))
rmse_5 = np.sqrt(np.mean((re - si_5)**2))
print("rmse between real and  with dropout 0.2: ", rmse_2)
print("rmse between real and  with dropout 0.5: ", rmse_5)
